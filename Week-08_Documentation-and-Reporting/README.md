...
### 📌 Brief Description of Key Header Values
...
- **rDNS (Reverse DNS):** Resolves an IP address to a hostname. If the hostname does not match the sender’s claimed organization, it may be suspicious.
